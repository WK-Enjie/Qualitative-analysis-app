            ...
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        ...
                        <div class="flow-box">+ Aqueous NaOH &rarr; White Precipitate (Soluble in excess)</div>
                        <div class="flow-box">+ Aqueous Ammonia &rarr; White Precipitate (Soluble in excess)</div>
                    </div>
                    <div class="flow-col">
                        <div class="flow-header">Anion Test</div>
                        <div class="flow-box">+ Dilute Nitric Acid</div>
        ...
        html: `
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        <div class="flow-header">Cation Test</div>
                        <div class="flow-box">+ Aqueous NaOH &rarr; Green Precipitate (Insoluble in excess)</div>
                        <div class="flow-box">+ Aqueous Ammonia &rarr; Green Precipitate (Insoluble in excess)</div>
                    </div>
                    <div class="flow-col">
                        <div class="flow-header">Anion Test</div>
                        <div class="flow-box">+ Dilute Nitric Acid</div>
            ...
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        <div class="flow-header">Cation Test</div>
                        <div class="flow-box">+ Aqueous NaOH &rarr; White Precipitate (Soluble in excess)</div>
                        <div class="flow-box">+ Aqueous Ammonia &rarr; White Precipitate (Insoluble in excess)</div>
                    </div>
                    <div class="flow-col">
                        <div class="flow-header">Anion Test</div>
                        <div class="flow-box">+ Dilute Nitric Acid</div>
    ...
    { 
        html: `
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        <div class="flow-header">Cation Test (in solution)</div>
                        <div class="flow-box">+ Aqueous Ammonia &rarr; Light Blue Precipitate</div>
        ...
        html: `
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        <div class="flow-header">Cation Test</div>
                        <div class="flow-box">+ Aqueous NaOH &rarr; White Precipitate (Insoluble)</div>
                        <div class="flow-box">+ Aqueous Ammonia &rarr; No Precipitate</div>
                    </div>
                    <div class="flow-col">
                        <div class="flow-header">Anion Test</div>
        ...
        html: `
            <div class="flowchart-container">
                ...
                <div class="flow-split-wrapper">
                    <div class="flow-col">
                        <div class="flow-header">Cation Test</div>
                        <div class="flow-box">+ Aqueous NaOH + Warm</div>
                        <div class="flow-box flow-result">Pungent gas produced</div>
                    </div>
                    <div class="flow-col">
                        <div class="flow-header">Anion Test</div>
                        <div class="flow-box">+ Dilute Nitric Acid + Silver Nitrate</div>
                        <div class="flow-box flow-result">White Precipitate</div>
                    </div>
                </div>
            </div>
